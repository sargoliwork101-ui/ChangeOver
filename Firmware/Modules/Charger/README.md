...
هر دو کانال نصب‌اند (`CHG_CHANNEL_1_INSTALLED = 1` و `CHG_CHANNEL_2_INSTALLED = 1`
به دستور راه‌اندازی کاربر ۲۰۲۶-۰۹-۲۰)؛ همهٔ وضعیت و زمان‌بندی پر-کانال مستقل است
...
می‌کند. برای تغییر مونتاژ فقط همین دو ثابت در `charger.h` عوض شوند.
