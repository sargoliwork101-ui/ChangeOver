...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, MCU_R_LED_Pin|MCU_Y_LED_Pin|MCU_G_LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : MCU_BUZZER_Pin */
  ...
  /*Configure GPIO pins : MCU_R_LED_Pin MCU_Y_LED_Pin MCU_G_LED_Pin */
  GPIO_InitStruct.Pin = MCU_R_LED_Pin|MCU_Y_LED_Pin|MCU_G_LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : MCU_INT_24_IN_Pin */
  GPIO_InitStruct.Pin = MCU_INT_24_IN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(MCU_INT_24_IN_GPIO_Port, &GPIO_InitStruct);
