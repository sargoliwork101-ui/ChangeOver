...
| حالت | امضا | دبانس |
|---|---|---|
| شارژ فعال + سیم باتری قطع | هر نیم‌باتری بالای `FAULT_BAT_DISCONNECT_MV` (14.8V) - پالس‌های فلای‌بک خازن خروجی را پمپ می‌کنند | ۲۰۰ms (۲۰ پاس؛ ۳۰/۵۰/۱۰۰/۱۵۰ms روی بنچ گاهی بوق فیک زدند؛ گره پمپ‌شده ~۰٫۵s بالای ۱۴٫۸V می‌ماند پس ۲۰۰ms هم می‌رسد - دستور کاربر ۲۰۲۶-۰۹-۱۹) |
...
همان ۲۰۰ms قاعده اول است). با نبودِ snapshot معتبر هیچ Set/Clear رخ نمی‌دهد.
