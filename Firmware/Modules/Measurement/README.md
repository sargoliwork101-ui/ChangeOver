...
| تاریخ | تغییر |
|---|---|
| 2026-09-19 | **مدین-۳ روی ولتاژ دو نیم‌باتری** (`v_bat_low`/`v_bat_high`، دستور کاربر): اسپایک‌های تک‌فریمی ADC روی گره سوئیچینگ، آستانهٔ ۱۴٫۸V آلارم قطع باتری را الکی می‌شکستند؛ مانند کانال‌های جریان، پیش‌فیلتر مدین بدون تأخیر اسپایک را می‌کشد و دبانس Fault به ۵۰ms سریع برگشت |
