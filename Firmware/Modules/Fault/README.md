...
| حالت | امضا | دبانس |
|---|---|---|
| شارژ فعال + سیم باتری قطع | هر نیم‌باتری بالای `FAULT_BAT_DISCONNECT_MV` (14.8V) - پالس‌های فلای‌بک خازن خروجی را پمپ می‌کنند | ۱۰۰ms (۱۰ پاس؛ ۳۰۰ms قدیمی در پیک هرگز پر نمی‌شد، ۵۰ms روی بنچ گاهی بوق زد؛ گره پمپ‌شده ~۰٫۵s بالای ۱۴٫۸V می‌ماند پس ۱۰۰ms هم می‌رسد - دستور کاربر ۲۰۲۶-۰۹-۱۹) |
...
همان ۱۰۰ms قاعده اول است). با نبودِ snapshot معتبر هیچ Set/Clear رخ نمی‌دهد.
