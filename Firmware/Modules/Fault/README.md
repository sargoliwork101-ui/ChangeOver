...
| حالت | امضا | دبانس |
|---|---|---|
| شارژ فعال + سیم باتری قطع | هر نیم‌باتری بالای `FAULT_BAT_DISCONNECT_MV` (14.8V) - پالس‌های فلای‌بک خازن خروجی را پمپ می‌کنند | ۳۰ms (۳ پاس؛ دبانس ۳۰۰ms قدیمی در پیک جریان هرگز پر نمی‌شد چون قطع‌سخت ۱۵٫۰V پمپ را در حد میلی‌ثانیه می‌خواباند - بررسی بنچ ۲۰۲۶-۰۹-۱۹) |
...
همان ۳۰ms قاعده اول است). با نبودِ snapshot معتبر هیچ Set/Clear رخ نمی‌دهد.
