...
| حالت | امضا | دبانس |
|---|---|---|
| شارژ فعال + سیم باتری قطع | هر نیم‌باتری بالای `FAULT_BAT_DISCONNECT_MV` (14.8V) - پالس‌های فلای‌بک خازن خروجی را پمپ می‌کنند | ۱۵۰ms (۱۵ پاس؛ ۳۰/۵۰/۱۰۰ms روی بنچ گاهی الکی بوق زدند؛ گره پمپ‌شده ~۰٫۵s بالای ۱۴٫۸V می‌ماند پس ۱۵۰ms هم می‌رسد - دستور کاربر ۲۰۲۶-۰۹-۱۹) |
