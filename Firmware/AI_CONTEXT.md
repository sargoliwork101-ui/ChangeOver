...
- از جداکننده‌های یکسان استفاده کن: `/* ==================== Buzzer / Beep ==================== */` یا `/* ==================== Green LED ==================== */`
...
بازر را از LED در کد جدا کن.

- الان تمام کدها و توابع مربوط به بازر را ببر انتهای کد بنویسشون (LED اول، بازر آخر)
- برای تفکیک بهتر یک روش پیدا کن: مثلاً دو بخش بزرگ `/* ==================== LED Scenarios ==================== */` و `/* ==================== Buzzer / Beep ==================== */`
