...
| تاریخ | تغییر |
|---|---|
| 2026-09-20 | **پایان ابزورب به روش زیرجریان (فرمول کاربر، پک ۴٫۵Ah):** قبلاً فقط شستشوی ۱۰ دقیقه‌ای می‌رفت FLOAT؛ حالا FLOAT = (شستشو ≥ ۱۰min) **AND** (زیرجریان <۵۰mA پایدار ۶۰s - معیار کلاسیک سرب-اسیدی ~C/90) **یا** سقف امن ۱ ساعت (`CHG_TAPER_CURRENT_MA 50`، `CHG_TAPER_SUSTAIN_MS 60000`، `CHG_ABSORB_MAX_MS 3600000`) - باتری هرگز-تیپر‌نشده پمپ را بیدار نگه نمی‌دارد؛ فیلدهای جدید `taperSinceTick`/`absorbEnterTick` |
