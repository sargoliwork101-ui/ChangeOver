...
**جریان از ۲۰۲۶-۰۹-۲۲ (دستور کاربر) بدون فیلتر نرم‌افزاری است:** Measurement
جریان خامِ سنکرون با وسط پنجرهٔ ON پالس PWM را فقط تبدیل و منتشر می‌کند و
شارژر هم بدون EMA مستقیماً همان مقدار تبدیل‌شده را به فرمول تخمین خروجی و باند
۶۳۰..۶۵۰mA می‌دهد (فیلترهای median/EMA جریان حذف شدند؛ rate-limit پله‌های duty
و JIT سخت‌افزاری جلوی hunting را می‌گیرند).
