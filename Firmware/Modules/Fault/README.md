...
| حالت | امضا | دبانس |
|---|---|---|
| شارژ فعال + سیم باتری قطع | هر نیم‌باتری بالای `FAULT_BAT_DISCONNECT_MV` (14.8V) - پالس‌های فلای‌بک خازن خروجی را پمپ می‌کنند | ۵۰ms (۵ پاس؛ ۳۰۰ms قدیمی در پیک هرگز پر نمی‌شد چون قطع‌سخت ۱۵٫۰V پمپ را در حد میلی‌ثانیه می‌خواباند، و ۳۰ms روی بنچ گاهی خودبه‌خود می‌پرید - دستور کاربر ۲۰۲۶-۰۹-۱۹) |
