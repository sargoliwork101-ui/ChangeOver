      ...
      TaskMeasurement                  Firmware/Rtos/Src/task_measurement.c
        هر MEASUREMENT_PERIOD_MS (10ms، بالای measurement.h):
          func__Measurement_Run()     Firmware/Modules/Measurement/measurement.c
            ...
            → گلوبال‌های مشترک UINT32_T__G__Meas* (هر تسک می‌خواند؛ در Live Expressions دیده می‌شود)
...
| تاریخ | تغییر |
|---|---|
| 2026-09-15 | مقادیر اندازه‌گیری گلوبال شدند (`UINT32_T__G__Meas*` / `BOOL_T__G__Meas*` در measurement) — هر تسک می‌تواند بخواند و در دیباگر با Live Expressions دیده می‌شود |
