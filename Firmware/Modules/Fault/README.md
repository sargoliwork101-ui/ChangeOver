...
| حالت | امضا | دبانس |
|---|---|---|
| شارژ فعال + سیم باتری قطع | هر نیم‌باتری بالای `FAULT_BAT_DISCONNECT_MV` (14.8V) - پالس‌های فلای‌بک خازن خروجی را پمپ می‌کنند | ۵۰ms (۵ پاس؛ بوق فیک‌ها ناشی از اسپایک تک‌فریمی ADC بودند که با **مدین-۳ ولتاژ دو نیم‌باتری در measurement.c** نابود شدند؛ آستانه ۱۴٫۸V عمداً به ۱۵٫۰V نرفت چون گره بالای ۱۵٫۰V فقط ~۰٫۱s شناور می‌ماند در برابر ~۰٫۵s بالای ۱۴٫۸V - دستور کاربر ۲۰۲۶-۰۹-۱۹) |
...
همان ۵۰ms قاعده اول است). با نبودِ snapshot معتبر هیچ Set/Clear رخ نمی‌دهد.
