...
(`FAULT_BAT_DISCONNECT_MV` 14.8V/100ms = ۱۰ پاس پشت‌سر برای امضای پمپ حین شارژ و
...
| تاریخ | تغییر |
|---|---|
| 2026-09-19 | ابزورب = پنجره تثبیت ولتاژ (دستور کاربر): ورود ۱۴٫۳V، پلهٔ duty ریز ۰٫۱٪ به‌جای ۰٫۵٪ برای نگه‌داشت ۱۴٫۴V بدون تلاطم مرزی؛ شستشوی ۱۰ دقیقه فقط در ۱۴٫۴..۱۴٫۵V جمع و بیرونش مکث می‌شود؛ **زیر ۱۴٫۳V برگشت به بالک + ریست شستشو** (تا حل مسئله آفست)؛ **عبور از ۱۴٫۶V کاهش سریع با پله ۰٫۵٪**. بالک و فلوت دست‌نخورده. ثابت‌ها: `CHG_ABSORB_ENTER_MV/TIMED_MAX_MV/OVER_MV/STEP_FINE_PERMILLE` |
