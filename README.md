...
یک caller صریح RTOS می‌تواند نتیجه مثبت را به `vTaskDelay(pdMS_TO_TICKS(nextCheckMs))` بدهد. تسک عمومی UI همچنان برای LED زمان‌بندی مستقل خودش را دارد و بوق خودکار به آن اضافه نشده است.
