 ...
 *         حالت با یک پرچم خطا پوشش داده می‌شوند - بالای ۱۴٫۸V به‌مدت ۳۰۰ms
 *         (امضای پمپ حین شارژ) یا پایین‌بودن هر دو نیم‌باتری از ۶V به‌مدت
...
#define FAULT_BAT_DISCONNECT_DEBOUNCE_MS    300u
