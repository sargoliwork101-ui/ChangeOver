...
| 2026-09-19 | **فلوت یعنی خاموشی واقعی پمپ (دستور کاربر):** قبلاً باند خنثیِ جریانِ کم (<۳۳۰mA) دیوتی ~۴-۵٪ را تا ابد فریز می‌کرد و «شارژ هنوز خاموش نشده» بود؛ الان روی FLOAT دیوتی با ضرب‌آهنگ زبری تا ۰ پلی می‌شود و پارک می‌ماند - باتری استراحت می‌کند و فقط افت زیر ۱۲٫۸V بالک را بیدار می‌کند |
| 2026-09-19 | **باگ فلوت گرفته شد (گزارش بنچ):** شاخهٔ «زیر ۱۴٫۳V» بی‌قیدانه FLOAT را هم به BULK می‌برد و شستشو را صفر می‌کرد → بعد از هر ۶۰۰۰۰۰ تیک شستشو دوباره از صفر می‌چرخید؛ الان قانون ریست فقط در حالت ABSORB اجرا می‌شود و FLOAT با افت تا ۱۳٫۵V زنده می‌ماند (فقط زیر ۱۲٫۸V reentry به بالک) |
